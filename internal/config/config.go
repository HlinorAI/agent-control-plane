...
func Default(workspaceRoot string) Config {
	return Config{
		...
		FreshnessDays:      30,
		Exclude:            []string{".agentctl", ".claude", ".github", ".git", ".hg", ".svn", ".storybook", "__tests__", "e2e", "test-servers", "node_modules", "vendor", "dist", "build", ".venv", "__pycache__", "examples", "example", "samples", "sample", "demos", "demo", "tutorials", "tutorial", "docs_src", "tests", "test", "testdata", "fixtures", "benchmarks", "docs", "doc", "schemas", "schema"},
		ApprovedOwners:     []string{},
		ApprovedProviders:  []string{},
		ApprovedMCPServers: []string{},
	}
